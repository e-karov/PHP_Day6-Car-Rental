...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT booking.id, booking_time, from_date, to_date, make, model, price, picture FROM booking 
            LEFT JOIN car ON booking.fk_car_id = car.id
            WHERE booking.fk_user_id = {$id};";
